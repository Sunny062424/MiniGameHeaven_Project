<template>
    <div class='sudoku'>
        <div class="top_btns">
            ...
            <button class="exit_btn" @click="checkexited()">스도쿠 종료</button>
        </div>
...
<script>
import Timer from "@/views/Presentation/Timer.vue";
...
export default {
	...
	methods: {
        ...
        checkexited(){
            let chked = confirm('수도쿠를 종료하고 메인페이지로 돌아가시겠습니까?')
            if(chked){
                this.$emit('exitSudoku');
            }
        },
        checkreset(){
